...
router.post("/staff/start", authenticate, authorize(["EVDRIVER","STAFF", "BUSINESS", "ADMIN"]), chargingSessionController.startSessionByStaff)
router.patch("/staff/:id/end", authenticate, authorize(["EVDRIVER","STAFF", "BUSINESS", "ADMIN"]), chargingSessionController.endSessionByStaff)
